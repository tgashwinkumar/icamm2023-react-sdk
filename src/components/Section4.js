        ...
        <div className="w-full lg:w-2/3 h-full px-6 py-6 lg:py-24 lg:px-[calc(100vw/12)]">
          <div className="flex flex-col space-x-4">
            ...
            <div className="text-black w-full pt-16 font-poppins text-justify">
              ...
              phenomenal growth and success. The department has strongly
              motivated faculty with diverse specialization in Mathematics which
              provides basics for pursuing research in basic sciences and also
              in interdisciplinary areas. The department organizes extension
